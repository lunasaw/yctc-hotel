...
public class CheckInWithServiceImpl implements CheckInWithService {
    ...
    @Override
    public ResultDO<List<CheckInWithDO>> getBycheckInWithCustomerId(long customerId) {
        List<CheckInWithDO> ListByCustomerId = null;
        try {
            ListByCustomerId = checkInWithDAO.getCheckInWithDOByCustomerId(customerId);
            LOG.info("getBycheckInWithCustomerId success, ListByCustomerId={}", ListByCustomerId);
            return new ResultDO<>(true, ResultCode.SUCCESS, ResultCode.MSG_SUCCESS, ListByCustomerId);
        } catch (Exception e) {
            e.printStackTrace();
            LOG.error("getBycheckInWithCustomerId error, customerId={}", customerId, e);
