...
public class FinanBillOCRResponse extends AbstractModel {
     ...
     */
    public void setFinanBillInfos(FinanBillInfo[] FinanBillInfos) {
        this.FinanBillInfos = FinanBillInfos;
    }
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        this.setParamArrayObj(map, prefix + "FinanBillInfos.", this.FinanBillInfos);
