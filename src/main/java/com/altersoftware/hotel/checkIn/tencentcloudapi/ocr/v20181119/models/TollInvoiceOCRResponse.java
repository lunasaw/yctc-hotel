...
public class TollInvoiceOCRResponse extends AbstractModel {

    /**
     * 过路过桥费发票识别结果，具体内容请点击左侧链接。
     */
    @SerializedName("TollInvoiceInfos")
    @Expose
    private TollInvoiceInfo[] TollInvoiceInfos;
    ...
    /**
     * Get 过路过桥费发票识别结果，具体内容请点击左侧链接。
     *
     * @return TollInvoiceInfos 过路过桥费发票识别结果，具体内容请点击左侧链接。
     */
    public TollInvoiceInfo[] getTollInvoiceInfos() {
        return this.TollInvoiceInfos;
    }
     ...
     */
    public void setTollInvoiceInfos(TollInvoiceInfo[] TollInvoiceInfos) {
        this.TollInvoiceInfos = TollInvoiceInfos;
    }
    ...
    public void toMap(HashMap<String, String> map, String prefix) {
        this.setParamArrayObj(map, prefix + "TollInvoiceInfos.", this.TollInvoiceInfos);
