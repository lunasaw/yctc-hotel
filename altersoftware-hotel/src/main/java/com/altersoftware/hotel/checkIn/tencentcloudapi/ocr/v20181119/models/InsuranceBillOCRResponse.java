...
public class InsuranceBillOCRResponse extends AbstractModel {
     ...
     */
    @SerializedName("InsuranceBillInfos")
    @Expose
     ...
     */
    public void setInsuranceBillInfos(InsuranceBillInfo[] InsuranceBillInfos) {
        this.InsuranceBillInfos = InsuranceBillInfos;
    }
